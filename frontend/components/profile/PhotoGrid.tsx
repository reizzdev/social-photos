  ...
  return (
    ...
    >
      ...
      {photos.map((photo) => {
        ...
        console.log("photo.users?.id:", photo.users?.id);
        ...
        console.log("photo.censored:", photo.censored);

        console.log("showUsername:", showUsername);



        console.log("shouldBlur RESULT:", shouldBlur);
            ...
            <div className="image-wrapper">
              ...
              <div
                ...
                onClick={() => {
                  ...
                  console.log("CLICK FOTO", photo.id);

                  console.log("shouldBlur on click:", shouldBlur);
